		...
		$.post("/ChinaLife/notice/findAll.do", function(info) {
			...
			for (var i = 0; i < info.length; i++) {
				...
				str += "<tr><td>"+ obj.title + "</td>" + "<td>"
						...
						+ obj.id + "'>查看</a> <a href='/ChinaLife/notice/del.do?id="
						+ obj.id + "'>删除</a></td></tr>";
			}
			$("#data").html(str);
...
<body>
    <div style="height: 300px;width: 70%;margin: auto">
        ...
        <div style="margin: auto;height: 230px;width: 800px;">
  		...
  		<div style="margin-left: 20%; margin-top: 150px;">
            <a href="/ChinaLife/jsp/admin/addNotice.jsp" class="btn btn-primary  active" role="button">添加新公告</a>
        </div>
</body>
</html>