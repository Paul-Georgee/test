		...
		$.post("/ChinaLife/video/findByItem.do", "pageNo=" + pn+
			...
			for (var i = 0; i < info.objects.length; i++) {
				...
				+ "</td><td><a href='/ChinaLife/video/show.do?id="
						...
						+ obj.publishTime + "</td><td><a href='/ChinaLife/"+
						"video/del.do?id="
						+ obj.id + "'>删除</a>  <a href='/ChinaLife/"+
						"video/findById.do?id="
						+ obj.id + "'>修改</a></td></tr>";
			}
			$("#data").html(str);
...
<table class="table table-striped">
	...
	<div style="font-size:20px;text-align: center;">
		<ul  id="pageUL"></ul>
			...
			<a href="/ChinaLife/jsp/admin/addVideo.jsp" class="btn btn-default btn-lg active" 
			style="margin-left: 45%" role="button">添加视频</a>
</body>
</html>