...
<body>
 <div style="background-color: white;width: 100%;height: 500px;margin: auto">
         <div style="height: 100px;width: 90%;margin: auto">
             ...
             method="post" enctype="multipart/form-data" onsubmit="return checkLast()">
		...
		var nameArray = [];
        	...
        	// 验证是否有附件
        	function checkFile(){
        		var file = $("input[name='eamilAttachment']").val();
        		if(file.length != 0){
        			return true;
        		}else{
        			return false;
        	...
        	function check(){
        		if (checkCon()|checkFile()) {
        			$("#contentSpan").html("")
					return true;
				}else{
					$("#contentSpan").html("请填写内容或者选择文件发送")
					return false;
				}
        	}
