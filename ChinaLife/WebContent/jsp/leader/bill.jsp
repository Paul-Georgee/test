    ...
    <div id="div2" class="divInp">
        <form id="f1">
            <div style="height: 40px;width: 100%;">
                ...
                <div class="inp-form-div pull-left">
                    <input class="input-sm" type="text" name="start" id="inp1" placeholder="格式xxxx-xx-xx" />
                </div>
            	 <div class="inp-name pull-left">
                    <label class="lab_Home control-label">结束日期:</label>
                </div>
                <div class="inp-form-div pull-left">
                    <input class="input-sm" type="text" name="end" id="demo" placeholder="格式xxxx-xx-xx"/>
                </div>
            ...
            <div style="height: 50px;width: 100%;">
                ...
                <div class="inp-name pull-left">
                    <button id="btn" type="button" class="btn btn-warning btn-sm" style="width:120px;margin-left:50px;" onclick="cutPage(1)">查询</button>
                </div>                
