		...
		<form action="/ChinaLife/gurantee/update.do" method="post" class="form-horizontal" role="form">
                        ...
                        <div class="form-group">
                            <div class=" pull-left left-make">
                                <dl class="dl-form dl-horizontal">
                                    <dt>审判状态</dt>
                                    <dd><label>
                                        <input checked="true" type="radio" name="Radios" id="radio1" value="yes" onclike="check()">
                                        同意
                                    </label></dd>
                                </dl>
                            </div>
                            <div class="pull-left left-make">
                                <label>
                                    <input type="radio" name="Radios" id="radio2" value="no">
                                        驳回
                                </label>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <div class=" ">
                                <dl class="dl-form dl-horizontal">
                                    <dt>审批意见</dt>
                                    <dd><textarea id="auditReason" onkeyup="check()" name="auditReason" class="form-control" rows="3" style="width:80%; resize: none;">
                ...
                <div class="div_btn modal-footer">
                    <button id="btn" type="submit" class="inp_add btn btn-primary" >提交</button>
