    ...
    <div id="div2" class="divInp">
        <form id="f1">
            ...
            <div class="inp-form-div pull-left">
                <input class="input-sm" type="text" name="start" placeholder="格式：1111-01-01"/>
            </div>
            <div class="inp-name pull-left">
                <label class="lab_Home control-label">结束时间:</label>
            </div>
            <div class="inp-form-div pull-left">
                <input class="  input-sm" type="text" name="end" placeholder="格式：1111-01-01"/>
            </div>
            <div class="inp-name pull-left">
            ...
            <div class="inp-name pull-left">
                <button type="button" class="btn btn-primary btn-sm" onclick="cutPage(1)">查询</button>
            </div>
        </form>
    </div>
