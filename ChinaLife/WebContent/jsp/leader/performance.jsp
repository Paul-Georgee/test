...
<!--             <div class="inp-name pull-left ">
            ...
            <div class="inp-form-div pull-left">
                <input class="inp input-sm" type="text" name="start"  placeholder="格式：1111-01-01"/>
            </div>
            <div class="pull-left" style="margin-left: 5px;" >
                <label class="lab_Name control-label">~</label>
            </div>
            <div class="inp-form-div pull-left">
                <input class="inp input-sm" type="text" name="end"  id="demo" placeholder="格式：1111-01-01"/>
            </div>
            <div class="inp-name pull-left">
                <button id="btn" type="button" class="btn_refer btn btn-warning btn-sm">查询</button>
            </div>
        </form>
