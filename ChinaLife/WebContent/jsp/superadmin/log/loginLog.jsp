...
function cutPage(pn){
	...
	$.post("/ChinaLife/loginlogs/findAll.do","pageNo="+pn+"&"+$("#f1").serialize(),function(info){
		//alert(JSON.stringify(info));
		var str="";
		for (var i = 0; i < info.objects.length; i++) {
			var obj=info.objects[i];
			str +="<tr><td>"+obj.loginTime+"</td><td>"+obj.content+"</td></tr>"
		}
		$("#data").html(str);
...
<form class="form-inline" role="form" id="f1" method="post">
